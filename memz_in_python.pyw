...
MEME_URLS = [
    ...
    "https://apps.microsoft.com/detail/9pmf91n3lz3m?hl=zh-TW&gl=TW",
    "https://www.google.com",
    "https://www.google.com/search?q=how+to+get+money&ie=UTF-8",
    "https://www.google.com/search?q=minecraft+hax+download+free+no+virus&ie=UTF-8",
    "https://en.wikipedia.org/wiki/MEMZ",
    "https://www.google.com/search?q=how+to+get+help+on+windows&ie=UTF-8",
    "https://bonzi.link/",
...
MSG_POOL = [
    ...
    ("Message From DarkArmy", "GHJDSfnhsdfnahJSPFWERPFF456F+F46bibsnfsnv"),
    ("lol", "Still Using This Computer?")
]
