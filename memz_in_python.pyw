...
MSG_POOL = [
    ("MEMZ Hamrless", "YOU KILLED MY TROJAN! Now your PC are going to die."),
    ("Credits", "Dark Army And Gemini Presents"),
    ("MEMZ Hamrless", "I WARNED YOU"),
    ("lol", "Still Using This Computer?"),
    ("MEMZ", "YOU TRIED SO HARD AND GOT SO FAR, BUT IN THE END, YOUR PC WAS STILL FXXXXXD!"),
    ("MEMZ ", "Well, hello there. I don't believe we've been properly introduced. I'm Bonzi!"),
    ("MEMZ Hamrless", "Uh, Club Penguin. Time to get banned!"),
    ("lol", "GET BETTER HAX NEXT TIME xD"),
    ("lol", "Have you tried turning it off and on again?"),
    ("lol",  "BSOD INCOMING"),
    ("lol",  "This is everything I want in my computer"),
    ("lol", "SecureBoot sucks"),
    ("lol",  "SOMEBODY ONCE TOLD ME THE MEMZ ARE GONNA ROLL ME"),
    ("lol",  "You failed at your 1337 h4x0r skillz"),
    ("lol",  "ENJOY THE NYAN CAT")
]
